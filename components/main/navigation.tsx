  ...
  return (
    <>
      ...
      >
        ...
        <div>
          <UserItem />
          <Item onClick={search.onOpen} label="Search" icon={SearchIcon} isSearch />
          <Item onClick={settings.onOpen} label="Settings" icon={Settings2} />
        ...
        <div className="mt-4">
          ...
          <Popover>
            <PopoverTrigger className="w-full mt-4">
              <Item label="Trash" icon={LucideTrash} />
            </PopoverTrigger>
            <PopoverContent
              className="p-0 w-72"
